...
def playblast_shot ():
    ...
    scene_full_name = cmds.file(query=True, sn=True)
    ...
    audio_node = cmds.timeControl (aPlayBackSliderPython, q=True, s=True)

    cmds.playblast (fmt='qt', f=video_name, s=audio_node, fo=True, sqt=False, cc=True, v=True, orn=False, fp=4, p=100, c='H.264', qlt=100, wh=[1280, 720], st=start_frame, et=end_frame)
